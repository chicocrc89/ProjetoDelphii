...
begin
  ...
  begin
    ...
    begin
      ...
      umfuncionario.setCadastro(StrToDate(self.edtCadastro.Text));
      umfuncionario.setUlt_Alt(StrToDate(self.edtUlt_alt.Text));

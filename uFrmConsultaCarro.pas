...
uses
  ...
  Vcl.StdCtrls, uFrmCadastroCarro,
  Data.DB, FireDAC.Stan.Intf, FireDAC.Stan.Option, FireDAC.Stan.Param,
  FireDAC.Stan.Error, FireDAC.DatS, FireDAC.Phys.Intf, FireDAC.DApt.Intf,
  FireDAC.Comp.DataSet, FireDAC.Comp.Client, Vcl.Grids, Vcl.DBGrids,
  Vcl.Buttons, uDM, uVeiculos, uControllerVeiculos;
...
begin
  ...
  self.umveiculo.setCadastro(Date);
  self.umveiculo.setUlt_Alt(Date);
  self.umFrmCadastroCarro.limpaedt;
  self.umFrmCadastroCarro.DesbloqueiaEdt;
  self.umFrmCadastroCarro.conhecaObj(umveiculo, umactrlveiculo);
  self.umFrmCadastroCarro.ShowModal;
...
begin
  ...
  if mMSG <> '' then
    ShowMessage('VEICULO' + self.edtPesquisar.Text + 'NÃO ENCONTRADO');
end;

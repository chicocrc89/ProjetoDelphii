...
uses uFrmConsultaCliente, uFrmConsultaFornecedor, uFrmCadastroCliente,
  ...
  uFrmConsultaServicos, uFrmCadastroServicos, uServicos, uControllerServicos, uVenda_Produtos, uControllerVenda_Produtos, uFrmCadastroVendas, uFrmConsultaVendas,
...
type
  ...
  public
    ...
    procedure PDvenda (pvendaproduto : Venda_Produtos; pctrlvendaproduto : ControllerVenda_Produtos);
...
procedure Interfaces.PDvenda(pvendaproduto: Venda_Produtos; pctrlvendaproduto: ControllerVenda_Produtos);
begin
  umFrmConsultaVenda.conhecaObj(pvendaproduto, pctrlvendaproduto);
